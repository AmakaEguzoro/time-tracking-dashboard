                    ...
                    <div class="box-main-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-4 col-4">
                                <h1 class="px-4" id ="time-work">${
                                  data[i].timeframes.current
                                }hrs</h1>
                            </div>
                            <div class="col-lg-12 col-sm-8 col-8">
                                <h6 class=" px-4 text-muted previous">${
                                  data[i].summary
                                } - <span id="previous-time-work">${
        data[i].timeframes.previous
      }rs</span></h6>
                            </div>
                        </div>
